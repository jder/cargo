...
fn preserve_line_endings_issue_2076() {
    ...
    let lock_edited = lock_expected.replace(
        "This file is automatically @generated by Cargo",
        "This is a change to force a rewrite of the file which is otherwise skipped.",
    );
    p.change_file("Cargo.lock", &lock_edited);
